...
token_struct tokenTable[MAX_TOKEN];

void vInitializeTokenTable(token_struct *table, int iMaxElements);
int iConstructLexicalTable(char *fileName, token_struct *table, int iMaxElements);
int iGetIndex(char *token);
int iComputeNumberLength(char *tokenNumber, int iLength);
int iGetNumToken(token_struct *table);
int iPrintTokenTable(token_struct *table);
int iFilePrintTokenTable(char *fileName, token_struct *table);
int iNextToken(token_struct *table);
void vLexicalAnalysis(char *fileName, token_struct *table, int iMaxElements);
